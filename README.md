# Available .AUCTION One-Word Domains (14,506)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-14%2C506%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **14,506 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 14,506 domains · **Median ask:** $28.82 · **High-demand under $2,500:** 3
...
| --------------- | --------- | --------- | ------------- | -------------- | ------ | ------ | ---------------- |
| abo.auction     | available | $4.99     | $52.99        | high           | low    | 3      | name.com         |
| tel.auction     | resell    | —         | —             | high           | low    | 3      | Dynadot Inc      |
| ads.auction     | premium   | $1,107    | $1,107        | high           | medium | 3      | namesilo         |
| aft.auction     | available | $4.99     | $52.99        | high           | low    | 3      | name.com         |
| bets.auction    | resell    | —         | —             | high           | low    | 4      | Dynadot Inc      |
| bar.auction     | premium   | $242      | $242          | high           | low    | 3      | namesilo         |
| cnn.auction     | available | $4.99     | —             | high           | low    | 3      | name.com         |
| snow.auction    | resell    | —         | —             | high           | low    | 4      | GoDaddy.com, LLC |
| bus.auction     | premium   | $500      | —             | high           | low    | 3      | name.com         |
| cue.auction     | available | $4.99     | —             | high           | low    | 3      | name.com         |
| phone.auction   | resell    | —         | —             | high           | low    | 5      | Epik LLC         |
| gym.auction     | premium   | $250      | —             | high           | low    | 3      | name.com         |
| dad.auction     | available | $4.99     | —             | high           | low    | 3      | name.com         |
| super.auction   | resell    | —         | —             | high           | medium | 5      | Dynadot Inc      |
| job.auction     | premium   | $1,250    | —             | high           | low    | 3      | name.com         |
| did.auction     | available | $4.99     | —             | high           | low    | 3      | name.com         |
| triad.auction   | resell    | —         | —             | high           | low    | 5      | GoDaddy.com, LLC |
| lot.auction     | premium   | $520      | $520          | high           | low    | 3      | namecheap        |
| die.auction     | available | $4.99     | —             | high           | low    | 3      | name.com         |
| bargain.auction | resell    | —         | —             | high           | low    | 7      | Porkbun LLC      |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 14,506 live domains                        |
...
> Unique Domains. *Available .AUCTION One-Word Domains*. Version 2026-09-26. Public GitHub extract for the exact Unique Domains search represented by this repository.
