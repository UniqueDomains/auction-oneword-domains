# Available .AUCTION One-Word Domains (32,495)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-32%2C495%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **32,495 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 32,495 domains · **Median ask:** $31.35 · **High-demand under $2,500:** 3
...
| lot.auction     | premium   | $500      | —             | high           | low    | 3      | name.com         |
| die.auction     | available | $4.99     | —             | high           | low    | 3      | name.com         |
| cricket.auction | resell    | —         | —             | high           | low    | 7      | Dynadot Inc      |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 32,495 live domains                        |
...
> Unique Domains. *Available .AUCTION One-Word Domains*. Version 2026-09-25. Public GitHub extract for the exact Unique Domains search represented by this repository.
